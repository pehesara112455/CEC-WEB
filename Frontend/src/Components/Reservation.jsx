...
const ReservationTable = ({openAddRes}) => {
  ...
  return (
    <div className=" flex w-full bg-gray-50 font-sans">
      ...
      <div className="w-full mx-auto bg-white p-6 rounded-xl shadow-sm border border-gray-100 min-h-[600px] flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
          ...
          <div className="flex flex-wrap items-center gap-6 w-full lg:w-auto">
            ...
            <button
            onClick={openAddRes}
                className="flex items-center gap-2 bg-red-900 text-white px-5 py-2 rounded font-bold hover:bg-red-800 transition-colors shadow-sm">
